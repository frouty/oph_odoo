...
class oph_etat_factory(osv.osv_memory):
    _name = "oph.fds.factory"
    _description = "Custom FDS"  # don't forget u for unicode char in the string value u"Rapport personnalisé"

    _columns = {
        'name'=fields.name('Name', size=32),
        'pxdelivery': fields.boolean('Prescription Delivery', help="Thick the box if necessary"),
        'tm': fields.boolean('Ticket Moderateur', help="Thick the box if necessary"),
