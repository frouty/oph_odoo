...
# # I will use the datewotime field instead.
# # I keep for further references.
...
#         return res
    ...
    _columns = {
             ...
             # # many problems with date
              ...
              'datewotime':fields.related('meeting_id', 'datewotime', type = 'date', string = 'Consultation Date', store = True),
...
#                                               'Tamponnade'),
            ...
            'capsulartensionring':fields.boolean('irisdevice', help = 'use of an capsular tension ring'),
