...
Quelle galere  
Une fois que l'on a créé le record dans stt_report.xml pas moyen que odoo le
récupere dans sa base de données. j'ai essayé de tous les effacer, de faire un
update sur le module oph pas moyen.
J'ai essayé d'effacer tous les odoo report et j'ai planté la database. J'ai du
en restore une nouvelle. 
