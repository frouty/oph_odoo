...
\subsection{Comment obtenir la liste des champs d'une table?}
\label{sec:listfield}
\begin{verbatim}
\d nom de la table ou \d+ nom de la table.
\end{verbatim}

\subsection{Comment changer de role?}
\label{sec:role}

\subsection{Comment terminer une session psql?}
\label{sec:endpsqlsession}
/\q

\subsection{Comment faire une requete dans sql}
\label{sec:requete_sql}

Comment faire une requete sql sur la base de donnée de production?
